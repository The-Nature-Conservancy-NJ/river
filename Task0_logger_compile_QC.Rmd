...
```{r}
# compile hobo logger data from 2016-2025
hobo <- logger_compile("2016", type = "hobo") %>%
  ...
  bind_rows(logger_compile("2024", type = "hobo")) %>%
...
hydro <- logger_compile("2016", type = "hydro") %>%
  ...
  bind_rows(logger_compile("2024", type = "hydro")) %>%
...
pldeur <- logger_compile("2016", type = "pldeur") %>%
  ...
  bind_rows(logger_compile("2024", type = "pldeur")) %>%
