...
Scatterplot matrix to inspect data. Code adapted from:
...
color_vector <- co <- c("olivedrab",
            "olivedrab2",
            wes_palettes$BottleRocket2[1:3])
